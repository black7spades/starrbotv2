  ...
  return (
    <div className="bot-card bg-discord-card rounded-xl border border-discord-border p-5 hover:border-discord-accent/50 transition-colors">
      ...
      <div className="flex items-center gap-2 border-t border-discord-border pt-3">
        ...
        <InviteButton
          clientId={(bot as any).clientId || bot.id}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-discord-accent/10 text-discord-accent hover:bg-discord-accent/20 transition-colors"
        />
      </div>
    </div>
  );
